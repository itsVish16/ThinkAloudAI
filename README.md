...
| Feature | Description |
|---|---|
| **Voice-to-Voice AI** | Real-time conversational interviewer via WebRTC (< 500ms latency) |
...
| **Main Service** | `8001` | FastAPI, PostgreSQL, Redis, RabbitMQ | DSA questions, code execution, progress tracking |
...
+--------+---------+
         ...
         v
+------------------+
| LangGraph + LLM  |  <-- State-aware response generation (Gemini / Fireworks)
+--------+---------+
         |
         v
+------------------+
...
| **Database** | Single PostgreSQL instance = single point of failure | Future: read replicas |
...
<div align="center">
  <sub>Built with care by <a href="https://github.com/itsVish16">Vishal</a></sub>
</div>
